// http://codepen.io/anon/pen/hKacw?editors=001
...
//Let's say three people signed up for our service, create 3 intances of User and add each to the users Array
  ...
  //code here
users[0] = new User("Sally", "sally@sailboats.com", "use the wind", 0);
users[1] = new User("Burt", "burt@sstreet.com", "big yellow bird", 0);
users[2] = new User("Ernie", "ernie@duncan.io", "bratty brother", 0);
...
questions[1] = new Question("T/F: JavaScript is just a scripting version of Java", ["true", "false"], "false" , 1 );
